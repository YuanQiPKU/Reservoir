...
void manage_account_page::on_manage_money_clicked() {
  ...
  connect(new_money_sort, &account_item_money::sortItems, this,
          &manage_account_page::sortAccountItems);
...
void manage_account_page::on_manage_time_clicked() {
  ...
  connect(new_time_sort, &account_item_time::sortItems, this,
          &manage_account_page::sort_time_AccountItems);
...
void manage_account_page::on_manage_kind_clicked() {
  ...
  connect(new_kind_sort, &account_item_kind::kind_sort, this,
          &manage_account_page::sort_kind_AccountItems);
