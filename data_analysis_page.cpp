...
data_analysis_page::data_analysis_page(QTabWidget *all_page, QWidget *parent)
  ...
  QCPScatterStyle scatterStyle1(QCPScatterStyle::ssCircle, QPen(Qt::black),
                                QBrush(Qt::white), 6);
  ...
  plot_1_in->xAxis->setRange(min_time - 60 * 3600 * 12,
                             max_time + 60 * 3600 * 12);
  ...
  QCPScatterStyle scatterStyle2(QCPScatterStyle::ssCircle, QPen(Qt::black),
                                QBrush(Qt::white), 6);
  ...
  plot_2_in->xAxis->setRange(min_time - 60 * 3600 * 12,
                             max_time + 60 * 3600 * 12);
