...
struct qt_meta_stringdata_CLASSlogin_pageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSlogin_pageENDCLASS = QtMocHelpers::stringData(
    "login_page",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSlogin_pageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject login_page::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSlogin_pageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSlogin_pageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSlogin_pageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *login_page::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSlogin_pageENDCLASS.stringdata0))
